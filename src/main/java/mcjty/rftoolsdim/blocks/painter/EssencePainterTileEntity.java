...
public class EssencePainterTileEntity extends GenericTileEntity implements DefaultSidedInventory {
    ...
    private InventoryHelper inventoryHelper = new InventoryHelper(this, EssencePainterContainer.factory, EssencePainterContainer.SIZE_DIMLETS+1);
    ...
    public int[] getSlotsForFace(EnumFacing side) {
        return EssencePainterContainer.factory.getAccessibleSlots();
    }

    @Override
    public boolean canInsertItem(int index, ItemStack itemStackIn, EnumFacing direction) {
        return EssencePainterContainer.factory.isInputSlot(index);
    }

    @Override
    public boolean canExtractItem(int index, ItemStack stack, EnumFacing direction) {
        return EssencePainterContainer.factory.isOutputSlot(index);
    }
    ...
    public void onSlotChanged(int index, ItemStack stack) {
        if (getWorld().isRemote && index == EssencePainterContainer.SLOT_TAB) {
