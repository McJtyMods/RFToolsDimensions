...
public enum FeatureType {
    ...
    FEATURE_DENSE_CAVES("DenseCaves", new TSet(TERRAIN_AMPLIFIED, TERRAIN_CAVERN, TERRAIN_CAVERN_OLD, TERRAIN_FLOODED_CAVERN, TERRAIN_CHAOTIC, TERRAIN_FLAT, TERRAIN_ISLAND, TERRAIN_ISLANDS, TERRAIN_LOW_CAVERN, TERRAIN_NORMAL, TERRAIN_PLATEAUS, TERRAIN_NEARLANDS, TERRAIN_SOLID, TERRAIN_WAVES, TERRAIN_FILLEDWAVES, TERRAIN_ROUGH), null, 0, 0),
    ...
    FEATURE_PYRAMIDS("Pyramids", new TSet(TERRAIN_AMPLIFIED, TERRAIN_CAVERN, TERRAIN_CAVERN_OLD, TERRAIN_FLOODED_CAVERN, TERRAIN_FLAT, TERRAIN_CHAOTIC, TERRAIN_ISLAND, TERRAIN_ISLANDS, TERRAIN_LOW_CAVERN, TERRAIN_NEARLANDS, TERRAIN_NORMAL, TERRAIN_PLATEAUS, TERRAIN_SOLID, TERRAIN_WAVES, TERRAIN_FILLEDWAVES, TERRAIN_ROUGH),
