...
public class EssencesModule implements IModule {
    ...
    public static final RegistryObject<TileEntityType<BlockAbsorberTileEntity>> TYPE_BLOCK_ABSORBER = TILES.register("block_absorber", () -> TileEntityType.Builder.of(BlockAbsorberTileEntity::new, BLOCK_ABSORBER.get()).build(null));
    ...
    public static final RegistryObject<TileEntityType<FluidAbsorberTileEntity>> TYPE_FLUID_ABSORBER = TILES.register("fluid_absorber", () -> TileEntityType.Builder.of(FluidAbsorberTileEntity::new, FLUID_ABSORBER.get()).build(null));
    ...
    public static final RegistryObject<TileEntityType<BiomeAbsorberTileEntity>> TYPE_BIOME_ABSORBER = TILES.register("biome_absorber", () -> TileEntityType.Builder.of(BiomeAbsorberTileEntity::new, BIOME_ABSORBER.get()).build(null));
