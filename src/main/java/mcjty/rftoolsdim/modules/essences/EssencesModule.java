...
public class EssencesModule implements IModule {
    ...
    public static final RegistryObject<Item> BLOCK_ABSORBER_ITEM = ITEMS.register("block_absorber", tab(() -> new BlockItem(BLOCK_ABSORBER.get(), Registration.createStandardProperties())));
    ...
    public static final RegistryObject<Item> FLUID_ABSORBER_ITEM = ITEMS.register("fluid_absorber", tab(() -> new BlockItem(FLUID_ABSORBER.get(), Registration.createStandardProperties())));
    ...
    public static final RegistryObject<Item> BIOME_ABSORBER_ITEM = ITEMS.register("biome_absorber", tab(() -> new BlockItem(BIOME_ABSORBER.get(), Registration.createStandardProperties())));
    ...
    public static final RegistryObject<Item> STRUCTURE_ABSORBER_ITEM = ITEMS.register("structure_absorber", tab(() -> new BlockItem(STRUCTURE_ABSORBER.get(), Registration.createStandardProperties())));
