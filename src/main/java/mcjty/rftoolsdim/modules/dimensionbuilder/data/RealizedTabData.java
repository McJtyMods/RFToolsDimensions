...
public record RealizedTabData(Optional<ResourceLocation> dimension,
    ...
    public static final RealizedTabData DEFAULT = new RealizedTabData(Optional.empty(), Optional.empty(), "", "", 0, 0, 0, 0);
    ...
    public RealizedTabData withDimension(ResourceLocation dimension) {
        return new RealizedTabData(Optional.ofNullable(dimension), name, descriptor, randomized, ticksLeft, rfCreateCost, rfMaintainCost, tickCost);
    }
