...
public class DimensionMonitorItem extends Item implements ITooltipSettings {
    ...
    private final TooltipBuilder tooltipBuilder = new TooltipBuilder()
            .info(key("message.rftoolsdim.shiftmessage"), TooltipBuilder.parameter("power", DimensionMonitorClientStuff::getPowerString))
            .infoShift(header(),
                    TooltipBuilder.parameter("power", DimensionMonitorClientStuff::getPowerString),
                    TooltipBuilder.parameter("name", DimensionMonitorClientStuff::getDimensionName));
