...
public class WorkbenchModule implements IModule {
    ...
    public static final RegistryObject<Item> WORKBENCH_ITEM = ITEMS.register("dimlet_workbench", tab(() -> new BlockItem(WORKBENCH.get(), Registration.createStandardProperties())));
    ...
    public static final RegistryObject<Item> HOLDER_ITEM = ITEMS.register("knowledge_holder", tab(() -> new BlockItem(HOLDER.get(), Registration.createStandardProperties())));
    ...
    public static final RegistryObject<Item> RESEARCHER_ITEM = ITEMS.register("researcher", tab(() -> new BlockItem(RESEARCHER.get(), Registration.createStandardProperties())));
