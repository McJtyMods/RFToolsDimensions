...
public class DimletConfiguration {
    ...
    public static void init(Configuration cfg) {
        rarityScalesBySize = cfg.get(CATEGORY_DIMLETS, "rarityScalesBySize", true, "Whether the rarity factor of each given rarity should be multiplied by the number of items in it").getBoolean();
