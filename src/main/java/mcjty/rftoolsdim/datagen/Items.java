...
public class Items extends BaseItemModelProvider {
    ...
    protected void registerModels() {
        ...
        itemGenerated(DimletModule.EMPTY_STRUCTURE_DIMLET.get(), "item/dimlets/empty_structure_dimlet");
        ...
        itemGenerated(DimletModule.EMPTY_TAG_DIMLET.get(), "item/dimlets/empty_tag_dimlet");
        itemGenerated(DimletModule.EMPTY_SKY_DIMLET.get(), "item/dimlets/empty_sky_dimlet");
        ...
        itemGenerated(DimletModule.STRUCTURE_DIMLET.get(), "item/dimlets/structure_dimlet");
        ...
        itemGenerated(DimletModule.TAG_DIMLET.get(), "item/dimlets/tag_dimlet");
        itemGenerated(DimletModule.SKY_DIMLET.get(), "item/dimlets/sky_dimlet");
